...
if(t.get("mail").indexOf("@qq.com") >= 0){
	...
	if(result!==null){
		...
		// 获得QQ名称
/*
// 因为获取qq昵称时，如果是中文会乱码，所以这里暂不打开
		(async () => {
			let res = await fetchJsonp('https://users.qzone.qq.com/fcg-bin/cgi_get_portrait.fcg?uins=' + prefix,{ jsonpCallbackFunction: 'portraitCallBack' });
			let data = await res.json();
			if(qq_nick == "Anonymous"){
			    qq_nick = Object.values(data)[0][6]
			}
		})();
*/
	}
